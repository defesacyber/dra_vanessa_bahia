 ...
 */
export function getPatientEvidence(maxItems = 2) {
 ...
 */
export function getNutritionistEvidence() {
    return evidenceDatabase;
}
/**
 * Busca evidências por contexto/keywords
 */
export function searchEvidence(keywords) {
 ...
 */
export function groupByEvidenceLevel() {
    const groups = {
        'A': [],
        'B': [],
        'C': [],
 ...
 */
export function formatCitation(evidence, style = 'abnt') {
 ...
 * Gera link para DOI
 */
export function getDoiLink(doi) {
    return `https://doi.org/${doi}`;
}
// ============================================
// Evidence Hook
// ============================================
export function useEvidence(userRole) {
    const getEvidence = () => {
        return userRole === 'nutritionist'
            ? getNutritionistEvidence()
            : getPatientEvidence();
    };
    const getPreview = (count = 2) => {
