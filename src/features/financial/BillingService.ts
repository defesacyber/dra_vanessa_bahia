import { BillingCycle, PatientAccess, PatientCostDetail } from './types';
...
export const BillingService = {
    ...
    calculateDailyRate(pricePerMonth: number, daysInCycle: number): number {
     ...
     */
    calculateActiveDays(access: PatientAccess, cycle: BillingCycle): number {
    ...
    calculateEstimate(activePatients: PatientAccess[]): { total: number, details: PatientCostDetail[] } {
